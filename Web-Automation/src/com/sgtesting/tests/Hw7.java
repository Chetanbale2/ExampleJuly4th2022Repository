...
public class Hw7 {
    ...
    private static void createtask() 
    {
    	try 
    	{
    		...
    		oBrowser.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("Robot building");
            Thread.sleep(2000); 
    ...
    private static void deletetask() 
    {
    	try 
    	{
    		 ...
    		 Thread.sleep(3000);
    		 oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[4]/div/div[3]")).click();
    		 Thread.sleep(3000);
